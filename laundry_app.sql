...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Bulan Mei 2026 pada 13.05
...
(11, 'admin', 'admin@mail.com', 'admin01', '$2y$10$rBG6s0gdPJDrNU9NXNxsAOGNIKDZAS..15cUo/i5xieIbcw2gxa1e', 'Karyawan');
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama_lengkap`, `email`, `no_telp`, `alamat`, `username`, `password`, `tanggal_daftar`) VALUES
(8, 'haha', 'haha@gmaol.com', '326236727', 'jakarta', 'haha', '$2y$10$0OUGvi1PqrW41YzX069s2e7dfXxC0PiblCi3oAAXUTu0Ke7V9HzJ.', '2026-05-11 22:17:20');
...
(27, 'CK-6A01F59', 'gugy', '786757', 'ygyu', 'Cuci Komplit Reguler', '2 Hari', 2, 8000, '11 Mei 2026', '12 Mei 2026', 16000, 16000, 0, 'Sukses', 'bersih');
...
--
ALTER TABLE `tb_order_ck`
  MODIFY `id_order_ck` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT untuk tabel `tb_order_cs`
--
ALTER TABLE `tb_order_cs`
  MODIFY `id_order_cs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `tb_order_dc`
--
ALTER TABLE `tb_order_dc`
  MODIFY `id_order_dc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `tb_riwayat_ck`
--
ALTER TABLE `tb_riwayat_ck`
  MODIFY `id_ck` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
