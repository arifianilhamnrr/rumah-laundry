		...
		<div class="p-8">
			<form action="" method="post" class="space-y-6">
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
					...
					<div class="space-y-4">
						<div>
							...
							<input type="text" name="nama_pel_ck" value="<?= htmlspecialchars($data_pelanggan['nama_lengkap']) ?>" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 cursor-not-allowed">
						</div>
						...
						<div>
							...
							<input type="text" name="no_telp_ck" value="<?= htmlspecialchars($data_pelanggan['no_telp']) ?>" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 cursor-not-allowed">
						</div>
						...
						<div>
							...
							<textarea name="alamat_ck" rows="4" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 cursor-not-allowed resize-none"><?= htmlspecialchars($data_pelanggan['alamat']) ?></textarea>
						</div>
					</div>
					...
					<div class="space-y-4">
						<div>
							...
							<select name="jenis_paket_ck" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all">
						...
						<div>
							...
							<input type="number" name="berat_qty_ck" placeholder="Masukkan berat dalam Kg" min="1" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all">
						</div>
						...
						<div>
							...
							<input type="date" name="tgl_masuk_ck" value="<?= date('Y-m-d') ?>" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all">
						</div>
						...
						<div>
							...
							<input type="date" name="tgl_keluar_ck" value="<?= date('Y-m-d', strtotime('+2 days')) ?>" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all">
						</div>
						...
						<div>
							...
							<textarea name="keterangan_ck" rows="4" placeholder="Contoh: Pisahkan pakaian putih" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all resize-none">-</textarea>
						</div>
				...
				<div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
					...
					<button type="submit" name="order_ck" class="px-6 py-3 bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
