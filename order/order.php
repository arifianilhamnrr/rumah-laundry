	...
	<div class="bg-white rounded-xl shadow-lg overflow-hidden">
		...
		<div class="p-8">
			<div class="text-center mb-8">
				<h3 class="text-xl font-semibold text-gray-800 mb-2">Pilih Paket</h3>
				<p class="text-gray-600">Pilih jenis layanan laundry untuk order baru</p>
			</div>

			<!-- Package Cards -->
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
				<!-- Cuci Komplit -->
				<a href="<?=url('order/order_ck.php')?>" class="group">
				...
				<!-- Dry Clean -->
				<a href="<?=url('order/order_dc.php')?>" class="group">
				...
				<!-- Cuci Satuan -->
				<a href="<?=url('order/order_cs.php')?>" class="group">
